...
function Header()
{
    ...
    $this->Cell(50,10,utf8_decode('Orden de Produccion Nro ' . $idcotizacion),0,0,'R');
...
$deffechaprod=date("d/m/Y", strtotime($_GET['deffechaprod']));
$pdf->Cell(0,5,"Fecha Inicio de Produccion: " . $deffechaprod,0,1,'R');
...
$pdf->Cell(170,8,'Descripcion',1,0,'C',0);
